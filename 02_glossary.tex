...
\label{sec:glossary}
\addcontentsline{toc}{chapter}{Acrònims i Glossari}
...
\acro{PLEM}{Programació Lineal Entera Mixta}
\end{acronym}
...
\newglossaryentry{Balsamiq_Mockups}
{
...
\label{sec:apps}
\addcontentsline{toc}{chapter}{Aplicacions (Apps)}
