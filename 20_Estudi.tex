...
\hline
Expensor & \includegraphics[width=0.7cm]{logo.png} & Complet & Alta &  \\ %TODO link
\hline
\end{tabular}
...
\subsubsection{\Gls{Av_formativa}}
Un cop es treballava amb prototips de fidelitat mitja (PH2, PV1 i PL1. Veure taula \ref{table:prototypes}), s'han concertat entrevistes amb els diferents usuaris per a que els provessin. Aquestes entrevistes s'han fet seguint una plantilla (figura \ref{fig:qf}) per fer una \gls{Av_formativa} als prototips. En total s'ha fet 22 entrevistes. %TODO link entrevistes
...
\subsubsection{\Gls{Av_sumarial} 2}
...
Com que el questionari USE està dividit en 4 seccions, s'ha calculat la nota de cada aplicació per cada secció (entre 0 i 10), veient així els punts forts i febles de cada aplicació. Es poden veure aquestes puntuacions a la figura \ref{fig:USE_3}
